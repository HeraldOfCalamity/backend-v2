...
from app.presentation.api.v1 import auth_routes, cita_routes, especialidad_routes, especialista_routes, officeConfig_routes, paciente_routes, permission_routes, role_routes, user_routes
